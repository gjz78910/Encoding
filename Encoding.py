...
if __name__ == "__main__":
    ...
    N_train = 50 # change this to alter the training sample size
    if N_train > N_samples:
        N_train = N_samples
    N_splits = 2 # the number of folds for the k-fold cross validation testing
    N_repeats = 1 # the number of repeats for the k-fold cross validation testing
    test_mode = True # whether to tune the parameters
    ...
    for perf_attribute in range(1,N_attributes+1): # for each performance attribubte
        for encoding in ['Labelencoder','Scaling','Onehotencoder']: # for each encoding scheme
            ...
            ###
            ### hyperparameter tuning and model learning
            ###
